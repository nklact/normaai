...
function App() {
  ...
  // Note: iOS WebView recovery is now handled natively in Rust (src-tauri/src/lib.rs)
  // The native implementation can detect when the WKWebView content process terminates
